<cfcomponent extends="AbstractAlertService">
	...
	<cffunction name="getAlertType" access="public" returntype="AlertType">
		<cfscript>
			...
			alertType.alertName = getServiceLabelType() & "J-1 Repatriation Expiring";
			alertType.alertDescription = "INSTITUTION ISSUE: repatriation insurance.   
										  <br><br>RESOLUTION: what to do?";
			alertType.levelDescription = "welcome to the DANGER ZONE";	
		...
		<cfquery name="dataset">
			<cfif getSunapsisEnvironment().getModule() eq "iom">
				...
				inner join (
					...
					case when isdate(jbCustomFields1.customField27)=1 then cast(jbCustomFields1.customField27 as date) else '1800-01-01' end as expireDate 
			...
			<cfif threatLevel eq 0>
				jbCustomFields1.customField27 < '2016-03-01'
